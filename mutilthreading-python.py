...
def extract_movie_details(movie_link):
    ...
    rating = movie_soup.find("span", attrs={"class": "ipc-rating-star--imdb"}).get_text() if movie_soup.find("span", attrs={"class": "ipc-rating-star--imdb"}) else None
    
    print(title, rating)

    with open('.results/movies.csv', mode='a') as f:
